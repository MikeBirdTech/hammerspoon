...
hs.hotkey.bind(meh, "6", function() windows.moveAndResize(1/3, 0, 1/3, 1/3) end)       -- Top third
hs.hotkey.bind(meh, "7", function() windows.moveAndResize(1/3, 1/3, 1/3, 1/3) end)     -- Middle third
hs.hotkey.bind(meh, "8", function() windows.moveAndResize(1/3, 2/3, 1/3, 1/3) end)     -- Bottom third
...
hs.hotkey.bind(hyper, "right", function() windows.moveToScreen("right") end)  -- Move to next screen
hs.hotkey.bind(hyper, "left", function() windows.moveToScreen("left") end)    -- Move to previous screen

-- Move to next/previous screen using Vim bindings with hyper key
hs.hotkey.bind(hyper, "L", function() windows.moveToScreen("right") end)  -- Move to next screen
hs.hotkey.bind(hyper, "H", function() windows.moveToScreen("left") end)   -- Move to previous screen

-- Move to specific screens
hs.hotkey.bind(hyper, "1", function() windows.moveToScreenIndex(1) end)
hs.hotkey.bind(hyper, "2", function() windows.moveToScreenIndex(2) end)
hs.hotkey.bind(hyper, "3", function() windows.moveToScreenIndex(3) end)
hs.hotkey.bind(hyper, "4", function() windows.moveToScreenIndex(4) end)

-- Print screen information
hs.hotkey.bind(hyper, "P", windows.listScreens)
